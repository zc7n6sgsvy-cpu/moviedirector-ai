...
export const PRODUCT_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Workspace · Treatment',
    body: 'Open any project (or the demo). Treatment is the high-level synopsis and creative north star. Defaults come from type templates (sitcom / film / commercial / anime / brand-fusion).',
    view: 'workspace',
    tab: 'treatment',
    navHint: 'Treatment tab',
  },
  {
    id: 'ws-storyboard',
    chapter: 'Director workspace',
    title: 'Workspace · Storyboard',
    body: 'Shot list with cinematic controls: description, camera, duration, emotion, acting cues, dialogue, sound, detailed camera notes. This is pro directing language — not a single prompt box.',
    view: 'workspace',
    tab: 'storyboard',
